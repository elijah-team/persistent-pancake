...
//		DeduceTypeResolve2 resolver = dc.get().resolver();
//
...
//			switch (e.getKind()) {
//				case NUMERIC:
//					tte.setAttached(new OS_BuiltinType(BuiltInTypes.SystemInteger),resolver );
//					//vte.type = tte;
//					break;
//				case CHAR_LITERAL:
//					tte.setAttached(new OS_BuiltinType(BuiltInTypes.SystemCharacter),resolver );
//					break;
//				case IDENT:
...
////					throw new NotImplementedException();
//						dc.reportDiagnostic(aResolveError);
//						tte.setAttached(new OS_UnknownType(new StatementWrapper(pce.getLeft(), null, null)), resolver);
//					}
//				}
//				break;
//				case DOT_EXP: {
...
//							}
//							if (best instanceof FunctionDef) {
//								tte.setAttached(((FunctionDef) best).getOS_Type(), resolver);
//								//vte.addPotentialType(instructionIndex, tte);
//							} else if (best instanceof ClassStatement) {
//								tte.setAttached(((ClassStatement) best).getOS_Type(), resolver);
...
//								tte.setAttached(tte1.getAttached(),resolver );
//							} else {
//								final int y = 2;
...
//									case USER:
//										vte1.type.setAttached(attached, resolver); // !!
//										break;
//									case USER_CLASS:
...
//										switch (attached.getType()) {
//											case USER:
//												vte1.type.setAttached(attached,dc.get().resolver() ); // !!
//												break;
//											case USER_CLASS:
//												final GenType gt = vte1.getGenType();
//												gt.setResolved(attached);
...
//					aTte.setAttached(aType, dc.get().resolver()); // since we know that tte.attached is always null here
//				}
//
//				@Override
...
//													} else
//														idte.type.setAttached(dc.gt(aType), dc.get().resolver());
//												}
//											});
//										} else {
//											throw new NotImplementedException();
